...
<h1 align="center">Emlak+: AI-Powered Real Estate Photo Editor</h1>
...
<p align="center">
  <img width="1200" alt="Emlak+ dashboard" src="public/hero.png" />
</p>

<p align="center">
  <a href="https://github.com/codehagen/Emlak+/blob/main/LICENSE.md">
    <img src="https://img.shields.io/github/license/codehagen/Emlak+?label=license&logo=github&color=f80&logoColor=fff" alt="License" />
  </a>
</p>
...
git clone https://github.com/codehagen/Emlak+.git
cd Emlak+
...
Emlak+ follows a modern web application architecture:
...
```env
# Database
DATABASE_URL=postgresql://username:password@localhost:5432/Emlak+
...
- [Open an issue](https://github.com/codehagen/Emlak+/issues) if you believe you've encountered a bug.
- Make a [pull request](https://github.com/codehagen/Emlak+/pull) to add new features/make quality-of-life improvements/fix bugs.

<a href="https://github.com/codehagen/Emlak+/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=codehagen/Emlak+" />
</a>

## Repo Activity

![Emlak+ repo activity – generated by Axiom](https://repobeats.axiom.co/api/embed/b221e29ccd5f3c11ba61d115b24e6924b6a4724f.svg "Repobeats analytics image")
